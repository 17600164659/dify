...
const NewAppDialog = ({ show, onSuccess, onClose }: NewAppDialogProps) => {
  ...
  const mutateTemplates = useCallback(() => mutate(), [])
  ...
  const onCreate: MouseEventHandler = useCallback(async () => {
    ...
    try {
      ...
      const app = await createApp({
        ...
        mode: isWithTemplate
          ? templates.data[selectedTemplateIndex].mode
          : newAppMode!,
        config: isWithTemplate
          ? templates.data[selectedTemplateIndex].model_config
          : undefined,
      })
  ...
  return (
    <>
      ...
      <Dialog
        ...
        footer={
          <>
            <Button borderRadius={1000} background="#F5F6F6" onClick={onClose}>
              {t("app.newApp.Cancel")}
            </Button>
            <Button
              borderRadius={1000}
      ...
      >
        <h3 style={{ marginBottom: 12 }} className={style.newItemCaption}>
        ...
        <div className="flex items-center justify-between gap-3 mb-8">
          ...
          {/* <AppIcon
            ...
            icon={emoji.icon}
            styles={{ background: "#F5F6F7", borderRadis: 12 }}
          /> */}
          <input
            ref={nameInputRef}
            placeholder={t("app.newApp.iPlolloDataSet") || ""}
              ...
              {templates?.data?.map((template, index) => (
                <li
                  ...
                  className={classNames(
                    style.listItem,
                    style.selectable,
                    selectedTemplateIndex === index && style.selected
                  )}
              ...
              <ul className="grid grid-cols-2 gap-4">
                <li
                  className={classNames(
                    style.listItem,
                    style.selectable,
                    newAppMode === "chat" && style.selected
                  )}
                  style={{
                    flexDirection: "row",
                  }}
                ...
                >
                  <div className="iconBox conversationIcon"></div>
                  <div className="contentBox">
                    <div className="title">{t("app.newApp.chatApp")}</div>
                  ...
                  {/* <div className={style.listItemTitle}>
                    <span className={style.newItemIcon}>
                      <span
                        className={classNames(
                          style.newItemIconImage,
                          style.newItemIconChat
                        )}
                      />
                    </span>
                    <div className={style.listItemHeading}>
                  ...
                  {/* <div
                    className={classNames(style.listItemFooter, "justify-end")}
                  >
                    <a
                      className={style.listItemLink}
                      href="https://udify.app/chat/7CQBa5yyvYLSkZtx"
                      target="_blank"
                    >
                      {t("app.newApp.previewDemo")}
                      <span
                        className={classNames(
                          style.linkIcon,
                          style.grayLinkIcon
                ...
                <li
                  className={classNames(
                    style.listItem,
                    style.selectable,
                    newAppMode === "completion" && style.selected
                  )}
                  style={{
                    flexDirection: "row",
                  }}
                ...
                >
                  <div className="iconBox textIcon"></div>
                  <div className="contentBox">
                    <div className="title">{t("app.newApp.completeApp")}</div>
                    <div className="content">
                  ...
                  >
                    <a
                      className={style.listItemLink}
                      href="https://udify.app/completion/aeFTj0VCb3Ok3TUE"
                      target="_blank"
                    >
                      {t("app.newApp.previewDemo")}
                      <span
