const translation = {
  ...
  account: {
    ...
    langGeniusAccount: '沃比医疗 account',
    langGeniusAccountTip: 'Your 沃比医疗 account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to 沃比医疗 to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by 沃比医疗 allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: '沃比医疗 {{version}} is now available.',
    latestAvailable: '沃比医疗 {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
