const translation = {
  ...
  welcome: 'Welcome to 沃比医疗, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting 沃比医疗 Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on 沃比医疗',
  invalid: 'The link has expired',
  explore: 'Explore 沃比医疗',
