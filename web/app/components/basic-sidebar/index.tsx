...
const logoUrl = 'https://assets.metaio.cc/assets/difyassets/bisailogo.png';
...
const AppDetailNav: FC<IAppDetailNavProps> = ({
  ...
  return (
    <div
      className="flex flex-col w-17 overflow-y-auto bg-white border-r border-gray-200 shrink-0"
      style={{
        zIndex: 10,
        padding: '20px 0',
        width: 90,
