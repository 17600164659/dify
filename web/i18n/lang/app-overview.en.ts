    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see AI金亮医生\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
        },
      },
      customize: {
        way: 'way',
        ...
        way1: {
          ...
          step1Operation: 'AI金亮医生-WebClient',
