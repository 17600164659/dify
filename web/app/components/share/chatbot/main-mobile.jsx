        ...
        <div className='main-container'>
            ...
            <div className='main-header'>
                ...
                <div className='main-menu'>
                    ...
                    <div className={'main-menu-item' + (contentType === 'news' ? ' active' : '')} onClick={() => setContentType('news')}><img src="https://assets.metaio.cc/assets/difyassets/main-yw.png" />Web3快讯</div>
                </div>
            </div>
            {
                contentType === 'chat' ? (
                                ...
                                return (
                                    <div className='main-app-news-item'>
                                        <div className='main-app-news-item-head'>
                                            <img src="https://assets.metaio.cc/assets/difyassets/cxctlogo.png" width={34} height={34} style={{ borderRad: 10 }} />
                                            Web3助手
                                        </div>
