const translation = {
  ...
  account: {
    ...
    name: 'Name',
    email: 'Email',
    langGeniusAccount: 'MetaIO account',
    langGeniusAccountTip: 'Your MetaIO account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    inviteTeamMemberTip: 'The other person will receive an email. If he\'s already a MetaIO user, he can access your team data directly after signing in.',
    email: 'Email',
    emailInvalid: 'Invalid Email Format',
    emailPlaceholder: 'Input Email',
    sendInvite: 'Send Invite',
    invitationSent: 'Invitation sent',
    invitationSentTip: 'The invitation is sent, and they can sign in to MetaIO to access your team data.',
    ok: 'OK',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by MetaIO allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'MetaIO {{version}} is now available.',
    latestAvailable: 'MetaIO {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
