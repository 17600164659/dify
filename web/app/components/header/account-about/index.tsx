            ...
            <div className='text-[#1C64F2]'>
              {
                IS_CE_EDITION
                  ...
                  : <>
                    <Link href={'https://ipollo.ai/user-agreement/privacy-policy'} target='_blank'>Privacy Policy</Link>,
                    <Link href={'https://ipollo.ai/user-agreement/terms-of-service'} target='_blank'>Terms of Service</Link>
                  </>
              }
            </div>
          </div>
