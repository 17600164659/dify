const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'wemoai.com account',
    langGeniusAccountTip: 'Your wemoai.com account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to wemoai.com to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by wemoai.com allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'wemoai.com {{version}} is now available.',
    latestAvailable: 'wemoai.com {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
