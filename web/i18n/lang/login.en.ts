const translation = {
  ...
  welcome: 'Welcome to 元宇未来, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting 元宇未来 Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on 元宇未来',
  invalid: 'The link has expired',
  explore: 'Explore 元宇未来',
