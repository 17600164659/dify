const translation = {
  ...
  account: {
    ...
    langGeniusAccount: '元宇未来 account',
    langGeniusAccountTip: 'Your 元宇未来 account and associated user data.',
    editName: 'Edit Name',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by 元宇未来 allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: '元宇未来 {{version}} is now available.',
    latestAvailable: '元宇未来 {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
