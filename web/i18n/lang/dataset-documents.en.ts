const translation = {
  list: {
    title: "Documents",
    desc: "All files of the dataset are shown here, and the entire dataset can be linked to MetaIO citations or indexed via the Chat plugin.",
    addFile: "add file",
    table: {
      header: {
        fileName: "FILE NAME",
    ...
    empty: {
      ...
      sync: {
        tip: "MetaIO will periodically download files from your Notion and complete processing.",
      },
    },
    delete: {
