const translation = {
  ...
  account: {
    ...
    langGeniusAccount: '卒息常谈 account',
    langGeniusAccountTip: 'Your 卒息常谈 account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to 卒息常谈 to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by 卒息常谈 allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: '卒息常谈 {{version}} is now available.',
    latestAvailable: '卒息常谈 {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
