const translation = {
  ...
  account: {
    ...
    email: '邮箱',
    edit: '编辑',
    langGeniusAccount: 'MetaIO 账号',
    langGeniusAccountTip: '您的 MetaIO 账号和相关的用户数据。',
    editName: '编辑名字',
  ...
  members: {
    ...
    inviteTeamMemberTip: '对方会收到一封邮件。如果他已经是 MetaIO 用户则可直接在登录后访问你的团队数据。',
    email: '邮箱',
    emailInvalid: '邮箱格式无效',
    emailPlaceholder: '输入邮箱',
    sendInvite: '发送邀请',
    invitationSent: '邀请已发送',
    invitationSentTip: '邀请已发送，对方登录 MetaIO 后即可访问你的团队数据。',
    ok: '好的',
    removeFromTeam: '移除团队',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: '体验',
      exhausted: '超出限额',
      desc: '托管 OpenAI 由 MetaIO 提供的托管 OpenAI 服务，你可以使用 GPT-3.5 等模型，在体验额度消耗完毕前你需要设置其它模型供应商。',
      callTimes: '调用次数',
  ...
  about: {
    changeLog: '更新日志',
    updateNow: '现在更新',
    nowAvailable: 'MetaIO {{version}} 现已可用。',
    latestAvailable: 'MetaIO {{version}} 已是最新版本。',
  },
  appMenus: {
    overview: '概览',
    promptEng: '提示词编排',
