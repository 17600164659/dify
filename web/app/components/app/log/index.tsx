    ...
    <div className='bg-gray-50 w-[560px] h-fit box-border px-5 py-4 rounded-2xl'>
      ...
      <div className='mt-2 text-gray-500 text-sm font-normal'>
        <Trans
          ...
          components={{ shareLink: <Link href={`${pathSegments.join('/')}/configuration`} className='text-primary-600' />, testLink: <Link href={appUrl} className='text-primary-600' target='_blank' /> }}
        />
      </div>
    </div>
  </div>
