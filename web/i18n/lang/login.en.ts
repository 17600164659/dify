const translation = {
  ...
  welcome: 'Welcome to 卒息常谈, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting 卒息常谈 Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on 卒息常谈',
  invalid: 'The link has expired',
  explore: 'Explore 卒息常谈',
