    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see MetaIO\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
        },
      },
      customize: {
        way: 'way',
        ...
        way1: {
          ...
          step1Operation: 'MetaIO-WebClient',
