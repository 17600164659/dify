    ...
    def post(self, app_model, end_user, c_id):
        ...
        try:
            return ConversationService.rename(
                app_model, conversation_id, end_user, args["name"]
            )
        except services.errors.conversation.ConversationNotExistsError:
            raise NotFound("Conversation Not Exists.")
...
api.add_resource(
    ConversationDetailApi, "/sessions/<uuid:c_id>", endpoint="conversation_detail"
)
api.add_resource(ConversationApi, "/sessions/<uuid:c_id>", endpoint="conversation")
