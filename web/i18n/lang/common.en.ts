const translation = {
  ...
  account: {
    ...
    name: 'Name',
    email: 'Email',
    langGeniusAccount: 'AI金亮医生 account',
    langGeniusAccountTip: 'Your AI金亮医生 account and associated user data.',
    editName: 'Edit Name',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by AI金亮医生 allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'AI金亮医生 {{version}} is now available.',
    latestAvailable: 'AI金亮医生 {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
