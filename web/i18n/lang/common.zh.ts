const translation = {
  ...
  account: {
    ...
    edit: '编辑',
    langGeniusAccount: '卒息常谈 账号',
    langGeniusAccountTip: '您的 卒息常谈 账号和相关的用户数据。',
    editName: '编辑名字',
  ...
  members: {
    ...
    invitationSentTip: '邀请已发送，对方登录 卒息常谈 后即可访问你的团队数据。',
    invitationLink: '邀请链接',
    ok: '好的',
    removeFromTeam: '移除团队',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: '体验',
      exhausted: '超出限额',
      desc: '托管 OpenAI 由 卒息常谈 提供的托管 OpenAI 服务，你可以使用 GPT-3.5 等模型，在体验额度消耗完毕前你需要设置其它模型供应商。',
      callTimes: '调用次数',
  ...
  about: {
    changeLog: '更新日志',
    updateNow: '现在更新',
    nowAvailable: '卒息常谈 {{version}} 现已可用。',
    latestAvailable: '卒息常谈 {{version}} 已是最新版本。',
  },
  appMenus: {
    overview: '概览',
    promptEng: '提示词编排',
